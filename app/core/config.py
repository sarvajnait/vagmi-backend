...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "Vagmi")
        ...
        self.API_V1_STR = "/" + API_V1_STR.lstrip("/").rstrip("/")
        ...
        self.LOG_FORMAT = os.getenv("LOG_FORMAT", "console")  # "json" or "console"

        # Postgres Configuration
        self.POSTGRES_URL = os.getenv(
            "POSTGRES_URL", "postgresql://username:password@localhost:5432/education_db"
        )
