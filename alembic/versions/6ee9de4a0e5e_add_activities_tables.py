...
Revision ID: 6ee9de4a0e5e
Revises: f3b7a9b0e4c1
Create Date: 2026-01-10 23:53:59.683406
...
def upgrade() -> None:
    ...
    if not inspector.has_table("activity_answers"):
        op.create_table(
            ...
            sa.Column(
                "submitted_answer_text", sqlmodel.sql.sqltypes.AutoString(), nullable=True
            ),
